...
if text == 'هلو' then
TextReply = 'هــلاوات يعممري 🥺❤️.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شلونكم' then
TextReply = 'تمـام وانت حبي 🙂❤️.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شلونك' then
TextReply = 'تمـام بخير ونت 💓.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'تمام' then
TextReply = 'دوم حيـاتي ☹️💗.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هلاو' then
...
if text == '😐' then
TextReply = ' لـيـش صافـن☹️💞.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هاي' then
TextReply = 'هايـات يعمري ☹️💗.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'لتزحف' then
...
if text == 'كلخرا' then
TextReply = 'لا تجبرنة ناكلك  😉.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'زاحف' then
TextReply = 'ماصرت مثـلك 😂😭.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'دي' then
TextReply = 'من جماعة دي نت 😂😕.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'فرخ' then
TextReply = 'اطلعبرا منريد فروخ بلكروب 😹💞'.
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'تعالي خاص' then
TextReply = 'لا تـروحيلة هذا زاحف 🙂😹💗.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'اكرهك' then
TextReply = 'الله عليك حبني😂💔.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'احبك' then
TextReply = 'خلنرتبط لعد 😎💓'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'باي' then
TextReply = 'جذاب راح يطمس 😂❤️'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'واكف' then
TextReply = 'شعندڪ واكف متكعد احنه مو بصف 🤣💓.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
...
if text == 'كفو' then
TextReply = 'كفـو منك حياتي 😂🇮🇶.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '😌' then
TextReply = 'شبيك ابنـي اكعد راحة 😂😔.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'اها' then
TextReply = 'ايـي حـتاتـي ☹️😹💞'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شسمج' then
TextReply = 'اسمها ام اللبن 🥳😹'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شسمك' then
TextReply = 'اسمهہ ابو اللبن 😭😂'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شوف' then
...
if text == 'شكو' then
TextReply = 'گلـشي ماكـو ارجع نام 😂🙂.'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'اوف' then
