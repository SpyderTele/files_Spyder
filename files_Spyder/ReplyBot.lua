...
if text == 'هلو' then
TextReply = 'ﮪݪـﯛ آت ححب 😇💚'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شلونكم' then
TextReply = '• تَمـآمہ وانتآ 💓 ،'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'شلونك' then
TextReply = '• تَمـآمہ حبيبيـہٰ 🙂💓 !'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'تمام' then
TextReply = 'دﯡٰم حيـﺎُتم 🌚💓'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == 'هلاو' then
...
if text == 'فرخ' then
TextReply = 'الـتصيـࢪ ڪانسر وتشمـࢪ 😗!،'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
...
if text == 'تحبني' then
TextReply = 'مـﺎُدࢪي خل اسأل حَحبيبتيہ تقبل 😫'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
if text == '🌚' then
...
if text == 'نايمين' then
TextReply = 'شتࢪيد منهم خليهم نايمين ❤️🙂'
send(msg.chat_id_, msg.id_,'['..TextReply..']')
return false
end
